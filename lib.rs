...
mod erc721 {
    use ink_storage::{
        traits::{SpreadAllocate, SpreadLayout, PackedLayout},
        Mapping,
    };
    ...
    pub struct Erc721 {
        ...
        /// Contract owners.
        owners: Mapping<AccountId, Access>,
        
    }   

    #[derive(Encode, Decode, Debug, PartialEq, Eq, Copy, Clone, PackedLayout, SpreadLayout)]
    ...
    mod tests {
        ...
        fn mint_works() {
            ...
            // Give access
            assert_eq!(erc721.set_access(accounts.alice), ());
